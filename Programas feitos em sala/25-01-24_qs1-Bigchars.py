...
#v = lambda x,y:  
#print(v(bigchars[0], "A"))
#determinar menor indice da letra e maior indice
#find(letra)
#rfind(letra) #acha o primeiro caracter da direita pra esquerda
#f""
#lista inicios =[numereos inteiros cada posição é o menor inicio da letra, em ordem alfabetica]
